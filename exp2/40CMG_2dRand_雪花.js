...
window.onload = function main()
{
	...
	//指定三角形的三个顶点
	var vertices=[vec2(-1.3,0.0),vec2(0.0,0.0),
				  vec2(1.3,0.0),vec2(0.0,-1.3),
				  vec2(-1.3,0.0),vec2(0.0,1.3),
				  vec2(1.3,0.0),vec2(0.0,0)];
	...
	{
		var j = Math.floor(Math.random()*8);  //随机选择三角形一个顶点
		var p = mult(0.4,add(p,vertices[j]));  //计算顶点与p点的中点
