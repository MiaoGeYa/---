...
var gamexplainText = document.getElementById("gamexplain");
var id = 0;
var crashId = " ";
var lastCrashId = " ";
...
gamexplainText.innerText = "Loading.....";
...
function init()
{
	...
	//gameexplainText.innerText = "游戏说明：";
}
...
{
	//障碍物cube
	var a = 1*50, b = getRandomInt(1,3)*50, c = 1*50;
	var geometry = new THREE.CubeGeometry(a,b,c);
	var material = new THREE.MeshBasicMaterial({ color:Math.random()*0xffffff, size:3 });
